...
const houseTypeOpts = [
  { value: 'Single house',                               icon: '🏡', main: 'Single house',                    sub: 'A house on its own, not attached to any other building' },
  { value: 'Duplex',                                     icon: '🏘️', main: 'Duplex',                          sub: 'A building with two separate living spaces side by side' },
  { value: 'Multi Residential (three units or more)',    icon: '🏢', main: 'Multi Residential (3+ units)',    sub: 'A building with several separate living spaces' },
  { value: 'Commercial/Industrial/Agricultural Building',icon: '🏭', main: 'Commercial/Industrial/Agricultural', sub: 'Building used for business, factories, or farm work' },
  { value: 'Institutional Living Quarters',              icon: '🏫', main: 'Institutional Living Quarters',   sub: 'Settings like schools, hospitals, or military bases' },
  { value: 'Other housing unit',                         icon: '🏕️', main: 'Other housing unit',              sub: 'Please specify (boat, cave, etc.)' },
]
const roofOpts = [
  { value: 'Strong Materials',                              icon: '💪', main: 'Strong Materials',              sub: 'Durable materials like metal or concrete' },
  { value: 'Light Materials',                               icon: '🪶', main: 'Light Materials',               sub: 'Lighter materials like tin, tiles, or plastic' },
  { value: 'Salvaged/Makeshift Materials',                  icon: '♻️', main: 'Salvaged/Makeshift Materials', sub: 'Recycled or temporary materials' },
  { value: 'Mixed but Predominantly Strong Materials',      icon: '🔨', main: 'Mixed (Mostly Strong)',         sub: 'Mostly strong, durable materials' },
  { value: 'Mixed but Predominantly Light Materials',       icon: '🌿', main: 'Mixed (Mostly Light)',          sub: 'Mostly light materials' },
  { value: 'Mixed but Predominantly Salvaged Materials',    icon: '🔧', main: 'Mixed (Mostly Salvaged)',       sub: 'Mostly salvaged materials' },
  { value: 'Not Applicable',                                icon: '➖', main: 'Not Applicable',                sub: 'Not applicable for this structure' },
]
const wallOpts = [
  { value: 'Strong Materials',                              icon: '🧱', main: 'Strong Materials',              sub: 'Concrete, brick, or stone' },
  { value: 'Light Materials',                               icon: '🎋', main: 'Light Materials',               sub: 'Wood or bamboo' },
  { value: 'Salvaged/Makeshift Materials',                  icon: '♻️', main: 'Salvaged/Makeshift Materials', sub: 'Reused or improvised materials' },
  { value: 'Mixed but Predominantly Strong Materials',      icon: '🏗️', main: 'Mixed (Mostly Strong)',         sub: 'Mostly concrete or brick' },
  { value: 'Mixed but Predominantly Light Materials',       icon: '🌳', main: 'Mixed (Mostly Light)',          sub: 'Mostly wood or bamboo' },
  { value: 'Mixed but Predominantly Salvaged Materials',    icon: '🔩', main: 'Mixed (Mostly Salvaged)',       sub: 'Primarily salvaged materials' },
  { value: 'Not Applicable',                                icon: '➖', main: 'Not Applicable',                sub: 'Not relevant for this structure' },
]
const tenureOpts = [
  { value: 'Own house and lot, owner-like possession',                    icon: '🏠', main: 'Own house and lot',                         sub: 'Owns both house and land' },
  { value: 'Rented house/room, including lot',                            icon: '💰', main: 'Rented house/room, including lot',           sub: 'Pays rent for dwelling and land' },
  { value: 'Own house, rented lot',                                       icon: '🏡', main: 'Own house, rented lot',                      sub: 'Owns house, rents land' },
  { value: 'Own house, rent-free lot with consent of owner',              icon: '✅', main: 'Own house, rent-free lot (with consent)',     sub: 'Owns house, uses land free with permission' },
  { value: 'Own house, rent-free lot without consent of owner',           icon: '⚠️', main: 'Own house, rent-free lot (no consent)',      sub: 'Owns house, occupies land without permission' },
  { value: 'Rent-free house and lot with consent of owner',               icon: '🤝', main: 'Rent-free house and lot (with consent)',     sub: "Lives rent-free with owner's permission" },
  { value: 'Rent-free house and lot without consent of owner',            icon: '🚫', main: 'Rent-free house and lot (no consent)',       sub: 'Occupies both without permission' },
  { value: 'Not Applicable',                                              icon: '➖', main: 'Not Applicable',                             sub: 'Cannot be determined' },
]
const toiletOpts = [
  { value: 'Water-sealed, sewer septic tank, used exclusively by household', icon: '🚽', main: 'Water-sealed (exclusive use)', sub: 'Private flush toilet with septic tank' },
  { value: 'Water-sealed, sewer septic tank, shared with other households',  icon: '🚾', main: 'Water-sealed (shared)',         sub: 'Shared flush toilet with septic tank' },
  { value: 'Closed pit',          icon: '🪣', main: 'Closed pit',        sub: 'Covered pit latrine' },
  { value: 'Open pit',            icon: '🕳️', main: 'Open pit',          sub: 'Waste in uncovered pit' },
  { value: 'Other toilet facility', icon: '📝', main: 'Others',           sub: 'Please specify' },
]
const waterOpts = [
  { value: 'Own use, faucet, community water system',  icon: '🚰', main: 'Own faucet, community water',   sub: 'Exclusive faucet, public supply' },
  { value: 'Shared, faucet, community water system',   icon: '💧', main: 'Shared faucet, community water', sub: 'Shared faucet, public supply' },
  { value: 'Own use, tubed / piped deep well',         icon: '⛲', main: 'Own deep well with pump',        sub: 'Exclusive deep well access' },
  { value: 'Shared, tubed / piped deep well',          icon: '🤝', main: 'Shared deep well with pump',     sub: 'Shared deep well access' },
  { value: 'Tubed / piped shallow well',               icon: '🪣', main: 'Shallow well with pump',         sub: 'Shallow groundwater source' },
  { value: 'Dug Well',                                 icon: '🕳️', main: 'Dug Well',                      sub: 'Manually or mechanically dug' },
  { value: 'Protected Spring',                         icon: '🌊', main: 'Protected Spring',               sub: 'Enclosed natural spring' },
  { value: 'Unprotected Spring',                       icon: '💦', main: 'Unprotected Spring',             sub: 'Natural spring without protection' },
  { value: 'Lake, river, rain',                        icon: '🌧️', main: 'Lake, river, rain',              sub: 'Surface water or rainwater' },
  { value: 'Peddler',                                  icon: '🚚', main: 'Peddler',                        sub: 'Water delivered by vendors' },
  { value: 'Other Water Supply',                       icon: '📝', main: 'Others',                         sub: 'Please specify' },
]
const garbageOpts = [
  { value: 'Garbage collection',                               icon: '🚛', main: 'Garbage collection',  sub: 'Regular collection by local government' },
  { value: 'Burning',                                          icon: '🔥', main: 'Burning',              sub: 'Household burns waste' },
  { value: 'Composting',                                       icon: '🌱', main: 'Composting',           sub: 'Biodegradable waste as fertilizer' },
  { value: 'Recycling',                                        icon: '♻️', main: 'Recycling',            sub: 'Non-biodegradable waste separated' },
  { value: 'Waste Segregation',                                icon: '🗑️', main: 'Waste Segregation',   sub: 'Garbage sorted before disposal' },
  { value: 'Pit with cover',                                   icon: '📦', main: 'Pit with cover',       sub: 'Waste buried in covered pit' },
  { value: 'Pit without cover',                                icon: '🕳️', main: 'Pit without cover',   sub: 'Waste in open pit' },
  { value: 'Throwing of garbage in rivers, vacant lots, etc.', icon: '⚠️', main: 'Improper disposal',  sub: 'Disposal in open spaces/waterways' },
  { value: 'Other Garbage Disposal',                           icon: '📝', main: 'Others',               sub: 'Please specify another method' },
]
